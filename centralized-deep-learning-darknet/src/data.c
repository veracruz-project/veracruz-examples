...
{
    if(args.m) args.paths = get_random_paths(args.paths, args.n, args.m);
    //data d = {0};
    data *out = args.d;
    out->shallow = 0;
    out->X = load_image_paths(args.paths, args.n, args.w, args.h);
    out->y = load_labels_paths(args.paths, args.n, args.labels, args.classes, 0);
    if(args.m) free(args.paths);
}
