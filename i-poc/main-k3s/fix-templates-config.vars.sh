...
sed -e "s/EXTERNAL_IP_USE/${EXTERNAL_IP_USE}/g" \
    ...
    -e "s/RUNTIME_HUGHEPAGES_SIZE_USE/${RUNTIME_HUGHEPAGES_SIZE_USE}/g" \
    -e "s/RUNTIME_POD_SIZE_USE/${RUNTIME_POD_SIZE_USE}/g" \
    -e "s/RUNTIME_CPU_SIZE_USE/${RUNTIME_CPU_SIZE_USE}/g" \
