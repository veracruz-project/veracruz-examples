...
def create_self_signed_cert(): # TODO: update comment
    """Create an Elliptic Curve key and self signed certificate using OpenSSL libraries
...
# XXX: baaaad
    ...
    if error_str is None:
        execute_string="./execute_program.sh "+policy_filename+" "+USER_CERT_FILE+" "+USER_KEY_FILE+" /output/prediction.0.jpg "+outputFile+" /program/detector.wasm"
